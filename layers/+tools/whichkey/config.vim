...
let g:which_key_map = {
    \ 'name' : '+leader-key',
       ...
       \ ' ' : {
             ...
             \ 'ge' : 'Jump to the end of a word backward',
             \ 'h'  : 'Jump to beginning of a word backward within cursor line',
             \ 'j'  : 'Jump downwards at the same column',
             \ 'k'  : 'Jump upwards at the same column',
             \ 'l'  : 'Jump to beginning of a word forward within cursor line',
