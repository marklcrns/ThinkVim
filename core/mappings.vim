...
inoremap <C-s> <Esc>:set spell<bar>norm i<C-g>u<Esc>[sviw"sy1z=viw"ty:let @l=line('.')<bar>let @c=virtcol('.')<CR>``a<C-g>u<Esc>:set nospell<bar>:echo getreg('l') . ":" . getreg('c') . " spell correct '" .getreg('s') . "' -> '" . getreg('t') . "'"<CR>la
